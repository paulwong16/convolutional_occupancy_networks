...
for c in ${CLASSES[@]}; do
  ...
  # echo "Moving OFF files to class folder"
  # cp $input_path_c/* $build_path_c/0_in
  ...
  cp /home/malei/zhijie/convolutional_occupancy_networks/data/MN40_watertight/$c/*.off $build_path_c/2_watertight
